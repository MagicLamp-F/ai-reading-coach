...
class ReflectionAdapterTests(unittest.TestCase):
    ...
    def test_hermes_agent_cli_sends_contract_and_parses_json(self):
        ...
        self.assertEqual(calls[0]["payload"]["route"], "reading.reflection.generate")
        self.assertEqual(calls[0]["payload"]["tool_policy"], "none")
        self.assertEqual(calls[0]["payload"]["output_schema"], "reflection_v1")
